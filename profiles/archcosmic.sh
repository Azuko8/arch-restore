...
if sudo pacman -S --needed --noconfirm fish git micro obs-studio btrfs-assistant solaar timeshift librewolf kitty flatpak libreoffice > /dev/null; then
