...
if sudo pacman -S --needed --noconfirm fish steam git micro gnome-tweaks obs-studio btrfs-assistant solaar timeshift librewolf ghostty flatpak > /dev/null; then
